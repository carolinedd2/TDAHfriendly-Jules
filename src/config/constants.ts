import { TopicMetaList, AllTopicsArray, TrailDetail, StudyItem } from '../types/types';
...
export const TOPIC_META_DATA: TopicMetaList = {
  "1": {
    ...
    subtopics: false,
    loader: () =>
  fetch("/data/topics/topic1.json")
    .then((res) => res.json() as Promise<StudyItem>)
  },
  "2": {
    id: "2",
  ...
  "10": {
    ...
    subtopics: false,
    loader: () =>
  fetch("/data/topics/topic10.json")
    .then((res) => res.json() as Promise<StudyItem>)
  },
  "11": {
    id: "11",
    ...
    subtopics: false,
    loader: () =>
  fetch("/data/topics/topic11.json")
    .then((res) => res.json() as Promise<StudyItem>)
  },
  "12": {
    id: "12",
    ...
    subtopics: false,
    loader: () =>
  fetch("/data/topics/topic12.json")
    .then((res) => res.json() as Promise<StudyItem>)
  },
  "13": {
    id: "13",
    ...
    subtopics: false,
    loader: () =>
  fetch("/data/topics/topic13.json")
    .then((res) => res.json() as Promise<StudyItem>)
  },
  "14": {
    id: "14",
    ...
    subtopics: false,
    loader: () =>
  fetch("/data/topics/topic14.json")
    .then((res) => res.json() as Promise<StudyItem>)
  },
  "15": {
    id: "15",
